package dev.vgandolfi.solver.orchestrator.infrastructure.controller;

import dev.vgandolfi.solver.orchestrator.application.dto.job.request.CreateMatrixJobRequest;
import dev.vgandolfi.solver.orchestrator.application.dto.job.request.CreateTspJobRequest;
import dev.vgandolfi.solver.orchestrator.application.dto.job.request.CreateVrpJobRequest;
...
import dev.vgandolfi.solver.orchestrator.application.mapper.JobInputMapper;
import dev.vgandolfi.solver.orchestrator.application.service.JobApplicationService;
import dev.vgandolfi.solver.orchestrator.application.validation.VrpFeasibilityValidator;
